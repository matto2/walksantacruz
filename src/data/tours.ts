...
export const tours: Tour[] = [
  {
    ...
    shortDescription:
      "Explore Santa Cruz's rich history, architecture, and culture on a relaxed 90-minute walking tour. Led by a knowledgeable local guide.",
    longDescription:
      "Journey through time as we explore downtown Santa Cruz's architectural gems and the historic Mission Hill district. Discover the stories behind the buildings, the people who shaped this coastal town, and the vibrant culture that makes Santa Cruz unique.",
    ...
    galleryImages: [
      {
        src: heartSquidRow,
        alt: "Squid Row alley",
        caption: "Squid Row - Photo by M. O'Leary",
      },
      {
        src: heartMission,
      ...
      },
      {
        src: heartVictorian,
        alt: "Victorian home",
        caption: "Historic Victorian - Photo by M. O'Leary",
      },
      {
        src: heartWalnutAve,
        alt: "Walnut Avenue",
      ...
      },
      {
        ...
        caption: "Downtown Santa Cruz - Photo by M. O'Leary",
      },
      {
        src: heartImg9265,
        alt: "Historic Santa Cruz building",
        caption: "Historic Santa Cruz - Photo by M. O'Leary",
      },
    ],
    ...
    itinerary: [
      {
        ...
        description:
          "Discover the Cooper House site, iconic Town Clock, and the oldest commercial building on Upper Pacific Avenue. Learn about the architectural heritage and early commerce that shaped downtown.",
      },
      {
        title: "See the Old Santa Cruz Mission Site",
        description:
          "Visit the 1822 adobe—the county's oldest and California's best-preserved Native mission residence. Enjoy stunning downtown views while learning about the complex history of Spanish colonization and the indigenous Ohlone people.",
      },
      {
        title: "Mission Plaza",
        description:
          "Explore how the Mission's plaza became the first business district and town center after 1830s secularization. Understand the transformation from religious center to commercial hub.",
      },
      {
        title: "Stroll down Squid Row",
        description:
          "Walk through this artistic alley that hosted the legendary '80s Calamari Festival. Discover unique architecture, galleries, and the creative spirit that defines Santa Cruz.",
      },
      {
        title: "Santa Cruz City Hall",
        description:
          "Discover the 1937 City Hall and 1940 Civic Auditorium, the city's government and cultural hub. Explore the surrounding gardens and learn about the civic pride that rebuilt Santa Cruz.",
      },
      {
        title: 'Walk Santa Cruz\'s "Garden District"',
        description:
          "Stroll through this walkable neighborhood lined with grand Victorian-era homes and lush gardens. See how Santa Cruz's prosperous families created an elegant residential enclave.",
      },
      {
        title: "Historic Del Mar Theater",
        description:
          "Stroll past this 1936 Art Deco movie palace and listen to the musicians that frequent the Pacific Garden Mall. Experience the vibrant street culture and architectural gems of downtown.",
      },
    ],
...

  {
    ...
    galleryImages: [
      {
        src: goldenGateVilla,
        alt: "Golden Gate Villa",
        caption: "Golden Gate Villa - Photo by Eugene Zelenko (Wikimedia)",
      },
      {
        src: beachHindsHouse,
        alt: "Historic Hinds House",
        caption: "Hinds House - Photo by M. O'Leary",
      },
      {
        src: beachImg0074,
        alt: "Beach Hill mansion",
        caption: "Beach Hill Estate - Photo by M. O'Leary",
      },
      {
        src: beachImg0083,
      ...
      },
      {
        src: beachDelMar,
        alt: "Del Mar Theater",
        caption: "Del Mar Theater - Photo by M. O'Leary",
      },
      {
        src: beachDowntown,
        alt: "Downtown Santa Cruz",
    ...
    meetingPoint: {
      ...
      appleUrl:
        "https://maps.apple.com/?address=300%20Beach%20St,%20Santa%20Cruz,%20CA%2095060",
    },
    bookingUrl:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "While we hope you'll stay for the full experience, we understand that sometimes plans change. Since this is a loop tour starting and ending near the beach, you're welcome to depart at any point. Just let your guide know. However, please note that we cannot provide refunds for partial participation. If you're unsure about the tour length, consider booking one of our shorter tours instead.",
      },
      {
...

  {
    ...
    galleryImages: [
      ...
      {
        src: bigWave,
        alt: "Big wave at Steamer Lane",
        caption: "Steamer Lane - Photo by Brocken Inaglory (Wikimedia)",
      },
      {
        src: otter,
        alt: "Sea otter in kelp",
        caption: "Sea Otter - Photo by David Ledig, BLM",
      },
      {
        src: cypressPoint,
        alt: "Cypress Point coastline",
        caption: "Cypress Point - Photo by M. O'Leary",
      },
      {
        src: img9631,
        alt: "Santa Cruz coastal view",
        caption: "Santa Cruz Coast - Photo by M. O'Leary",
      },
      {
        src: brokenInaglory,
        alt: "Surfing at Santa Cruz",
        caption: "Santa Cruz Surfing - Photo by Brocken Inaglory (Wikimedia)",
      },
      {
        src: pexelsSurf,
        alt: "Surfer on wave",
        caption: "Surfing - Photo by Steven Bero (Pexels)",
      },
      {
        src: surfingClub,
        alt: "Surfing Club at UCSC",
        caption: "Surfing Club 1941 - Mayo collection, UCSC Digital Archives",
      },
    ],
    ...
    seoTitle:
      "Santa Cruz Surfing & Beach Culture Walking Tour | Walk Santa Cruz",
    seoDescription:
      "Explore Santa Cruz surfing history, watch surfers at legendary Steamer Lane, spot marine wildlife, and discover beach culture on this 2-hour oceanfront walking tour. Expert guides, small groups.",
    keywords: [
